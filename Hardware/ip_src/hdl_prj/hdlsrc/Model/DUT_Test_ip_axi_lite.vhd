-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\Model\DUT_Test_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: DUT_Test_ip_axi_lite
-- Source Path: DUT_Test_ip/DUT_Test_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY DUT_Test_ip_axi_lite IS
...
END DUT_Test_ip_axi_lite;


ARCHITECTURE rtl OF DUT_Test_ip_axi_lite IS

  -- Component Declarations
  COMPONENT DUT_Test_ip_addr_decoder
  ...
  COMPONENT DUT_Test_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : DUT_Test_ip_addr_decoder
    USE ENTITY work.DUT_Test_ip_addr_decoder(rtl);

  FOR ALL : DUT_Test_ip_axi_lite_module
    USE ENTITY work.DUT_Test_ip_axi_lite_module(rtl);
...
BEGIN
  u_DUT_Test_ip_addr_decoder_inst : DUT_Test_ip_addr_decoder
  ...
  u_DUT_Test_ip_axi_lite_module_inst : DUT_Test_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
