...
//------------------------Parameter----------------------
localparam
    ADDR_GOER_CFG_COS_OMEGA_0_DATA_0  = 7'h10,
    ADDR_GOER_CFG_COS_OMEGA_0_CTRL    = 7'h14,
    ADDR_GOER_CFG_COS_OMEGA_1_DATA_0  = 7'h18,
    ADDR_GOER_CFG_COS_OMEGA_1_CTRL    = 7'h1c,
    ADDR_GOER_CFG_COS_OMEGA2_0_DATA_0 = 7'h20,
    ADDR_GOER_CFG_COS_OMEGA2_0_CTRL   = 7'h24,
    ADDR_GOER_CFG_COS_OMEGA2_1_DATA_0 = 7'h28,
    ADDR_GOER_CFG_COS_OMEGA2_1_CTRL   = 7'h2c,
    ADDR_GOER_CFG_SIN_OMEGA_0_DATA_0  = 7'h30,
    ADDR_GOER_CFG_SIN_OMEGA_0_CTRL    = 7'h34,
    ADDR_GOER_CFG_SIN_OMEGA_1_DATA_0  = 7'h38,
    ADDR_GOER_CFG_SIN_OMEGA_1_CTRL    = 7'h3c,
    ADDR_DEBL_CFG_DATA_0              = 7'h40,
    ADDR_DEBL_CFG_CTRL                = 7'h44,
    WRIDLE                            = 2'd0,
    WRDATA                            = 2'd1,
    WRRESP                            = 2'd2,
    WRRESET                           = 2'd3,
