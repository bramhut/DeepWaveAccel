...
entity deepwaveaccel_fifo_w25_d4_S is 
    generic (
...
architecture rtl of deepwaveaccel_fifo_w25_d4_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component deepwaveaccel_fifo_w25_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 25;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
...
begin
----------------------- Instantiation -----------------------
    U_deepwaveaccel_fifo_w25_d4_S_ShiftReg : deepwaveaccel_fifo_w25_d4_S_ShiftReg
    generic map (
...
entity deepwaveaccel_fifo_w25_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 25;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end deepwaveaccel_fifo_w25_d4_S_ShiftReg;

architecture rtl of deepwaveaccel_fifo_w25_d4_S_ShiftReg is
