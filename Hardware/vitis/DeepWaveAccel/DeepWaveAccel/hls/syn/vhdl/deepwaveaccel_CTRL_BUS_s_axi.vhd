...
architecture behave of deepwaveaccel_CTRL_BUS_s_axi is
    ...
    constant ADDR_GOER_CFG_COS_OMEGA_0_DATA_0  : INTEGER := 16#10#;
    constant ADDR_GOER_CFG_COS_OMEGA_0_CTRL    : INTEGER := 16#14#;
    constant ADDR_GOER_CFG_COS_OMEGA_1_DATA_0  : INTEGER := 16#18#;
    constant ADDR_GOER_CFG_COS_OMEGA_1_CTRL    : INTEGER := 16#1c#;
    constant ADDR_GOER_CFG_COS_OMEGA2_0_DATA_0 : INTEGER := 16#20#;
    constant ADDR_GOER_CFG_COS_OMEGA2_0_CTRL   : INTEGER := 16#24#;
    constant ADDR_GOER_CFG_COS_OMEGA2_1_DATA_0 : INTEGER := 16#28#;
    constant ADDR_GOER_CFG_COS_OMEGA2_1_CTRL   : INTEGER := 16#2c#;
    constant ADDR_GOER_CFG_SIN_OMEGA_0_DATA_0  : INTEGER := 16#30#;
    constant ADDR_GOER_CFG_SIN_OMEGA_0_CTRL    : INTEGER := 16#34#;
    constant ADDR_GOER_CFG_SIN_OMEGA_1_DATA_0  : INTEGER := 16#38#;
    constant ADDR_GOER_CFG_SIN_OMEGA_1_CTRL    : INTEGER := 16#3c#;
    constant ADDR_DEBL_CFG_DATA_0              : INTEGER := 16#40#;
    constant ADDR_DEBL_CFG_CTRL                : INTEGER := 16#44#;
