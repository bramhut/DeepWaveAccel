...
def eigh(A, B=None, tau=1, N=None):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.math.linalg import eigh
       import scipy.linalg as linalg
...
def rot(axis, angle):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.math.linalg import rot
...
def z_rot2angle(R):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.math.linalg import z_rot2angle
