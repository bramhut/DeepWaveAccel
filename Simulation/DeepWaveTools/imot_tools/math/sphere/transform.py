...
def eq2cart(r, lat, lon):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.math.sphere.transform import eq2cart
...
def cart2pol(x, y, z):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.math.sphere.transform import cart2pol
...
def cart2eq(x, y, z):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.math.sphere.transform import cart2eq
