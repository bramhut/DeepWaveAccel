...
import DeepWaveTools.imot_tools.math.func as func
import DeepWaveTools.imot_tools.math.sphere.grid as grid
import DeepWaveTools.imot_tools.math.sphere.transform as transform
import DeepWaveTools.imot_tools.util.argcheck as chk
...
class EqualAngleInterpolator(Interpolator):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.math.func import SphericalDirichlet
       from DeepWaveTools.imot_tools.math.sphere.grid import equal_angle
       from DeepWaveTools.imot_tools.math.sphere.interpolate import EqualAngleInterpolator
       from DeepWaveTools.imot_tools.math.sphere.transform import pol2cart
