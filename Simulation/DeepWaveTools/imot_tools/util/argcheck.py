...
def check(*args):
    ...
    *args
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import check, require_all
...
def allow_None(func):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import allow_None, check, is_integer
...
def accept_any(*funcs):
    ...
    *funcs : list(bool_func)
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import accept_any, check, has_shape
...
def require_all(*funcs):
    ...
    *funcs : list(bool_func)
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import require_all, check
...
def is_instance(*klass):
    ...
    *klass : list(type)
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import is_instance, check
...
def is_scalar(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import is_scalar
...
def is_array_like(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import is_array_like
...
def is_array_shape(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import is_array_shape
...
def has_shape(shape):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import has_shape, check
...
def is_integer(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import is_integer
...
def has_integers(x):
    ...
    .. testsetup::
       ...
       import numpy as np
       from DeepWaveTools.imot_tools.util.argcheck import has_integers
...
def is_boolean(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import is_boolean
...
def has_booleans(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import has_booleans
...
def is_even(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import is_even
...
def has_evens(x):
    ...
    .. testsetup::
       ...
       import numpy as np
       from DeepWaveTools.imot_tools.util.argcheck import has_evens
...
def is_odd(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import is_odd
...
def has_odds(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import has_odds
...
def is_pow2(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import is_pow2
...
def has_pow2s(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import has_pow2s
...
def is_complex(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import is_complex
...
def has_complex(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import has_complex
...
def is_real(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import is_real
...
def has_reals(x):
    ...
    .. testsetup::
       ...
       from DeepWaveTools.imot_tools.util.argcheck import has_reals
